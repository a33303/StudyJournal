...
<template>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
      <h2 class="text-2xl font-extrabold text-gray-900">Study Journal</h2>
      ...
      <div class="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6">
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Students</p>
        </div>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Groupes</p>
        </div>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Journals</p>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Study Plans</p>
        </div>
        </div>
      </div>
    </div>
